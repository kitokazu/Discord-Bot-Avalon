...
// Add new boards to this BoardDict
// Change Board5 to something else...
const boardDict = {
  1: new Boards.Board1(),
  2: new Boards.Board2(),
  3: new Boards.Board5(),
...
function startGame(msg) {
  ...
  msg.channel.send(`>>> Starting an Avalon Game!
Click the checkmark to join the game!`)
...
function messageRoles(msg, assignedPlayers){
  ...
  // How to get round status...
  // console.log(board.getRoundStatus);
...
function createMission(msg, assignedPlayers){
  ...
  msg.channel.send(`${leader.username} is the leader of the mission.`);
